...
class LN5644 {
	public:
		...
		void setAnods(SDigitalOutput pins[]);    // установить пины анодов
		void setCatods(SDigitalOutput pins[]);    // установить пины катодов
	...
	private:
		...
		SDigitalOutput _anods[4];    // пины анодов
		SDigitalOutput _catods[8];    // пины катодов
		...
		void _write(SDigitalOutput out, int value);    // записать значение в заданный выход
